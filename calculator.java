...
public class Calculator {
    ...
    private Calculator() {
        ...
        int j = -1;
        int k = -1;
        int[] x = {marginX, marginX + 90, 200, 290, marginX+370, marginX+470,marginX + 570 , marginX + 670,marginX+770,marginX+870};
     ...
     //End of button X^x
      ...
      //Start of ans button
            ...
            btnCosh.addActionListener(event -> {
             ...
             btnnCr.setBounds(x[9],y[2],wBtn,hBtn);
